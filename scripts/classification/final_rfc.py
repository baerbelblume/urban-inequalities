...
def heatmap(x, y, size):
    ...
    plt.title('Health Deprivation', fontdict={'fontsize': '20', 'fontweight' : '3', 'family' : 'serif'})
    plt.show()
...
for train_index, test_index in skf.split(X, y.values.ravel()):
     ...
     rfc = RandomForestClassifier(criterion='entropy', n_estimators=500, max_features=1)
     ...
     y_true = y_true['mean_income'].values
